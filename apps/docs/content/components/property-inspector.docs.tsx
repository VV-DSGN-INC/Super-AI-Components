...
import {
  ...
  GoodTwoScopes,
  GoodUsefulEmpty,
} from "./property-inspector.examples";
...
export const PropertyInspectorDocs: ComponentDocs = {
  ...
  anatomy: [
    {
      slot: "property-inspector",
      note: "Root region, labelled by its own title. Carries `data-element-type` for whatever is selected.",
    },
    ...
    {
      slot: "property-inspector-section-rows",
      note: "The section's rows, unmounted while the group is collapsed.",
    },
    {
      slot: "field-row",
    ...
    {
      slot: "property-inspector-empty",
      note: "Shown when nothing is selected: one line of guidance plus whatever stays editable.",
    },
    {
      slot: "property-inspector-empty-content",
      note: "Document- or canvas-level rows that survive an empty selection.",
    },
  ],
  usage:
