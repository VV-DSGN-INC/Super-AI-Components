...
export const RecommendationCardDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "recommendation-card-apps",
      note: "The tools this recommendation touches — the 'apps' in apps + steps.",
    },
    {
      slot: "recommendation-card-trigger",
      note: "Try it — opens the modal. Carries real aria-expanded/aria-haspopup.",
    },
    {
      slot: "recommendation-card-save",
      note: "Save for later — the middle option, mirrored in the row and the modal footer.",
    },
    ...
    {
      slot: "recommendation-card-commit",
      note: "The modal's actual commit action, after the steps are visible.",
    },
  ],
  usage:
