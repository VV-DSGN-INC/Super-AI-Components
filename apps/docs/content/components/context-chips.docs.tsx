...
export const ContextChipsDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "context-chip-remove",
      note: "Sibling remove button inside a chip — never the chip itself made clickable.",
    },
    {
      slot: "context-chip-overflow",
      note: "The '+N' summary chip that collapses references past the visible set.",
    },
  ],
  usage:
