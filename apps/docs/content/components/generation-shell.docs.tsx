...
export const GenerationShellDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "generation-shell",
      note: "Root. Full height, no scroll of its own — the two panes scroll independently.",
    },
    {
      slot: "result-card",
      note: "Each F1 card in the results pane; carries `data-result-id` so a result can be addressed without reaching for its index.",
    },
  ],
  usage:
