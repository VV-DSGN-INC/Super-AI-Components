...
export const EntityRowDocs: ComponentDocs = {
  ...
  pitfalls: [
    ...
    'The row lays out with physical classes (`text-left`), so under `dir="rtl"` the flex order mirrors but the title and description stay pinned to the visual left, away from the icon. Nothing in the registry uses logical properties yet; if you ship RTL, override `text-align` at the call site.',
  ],
};
