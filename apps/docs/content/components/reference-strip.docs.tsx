...
export const ReferenceStripDocs: ComponentDocs = {
  ...
  anatomy: [
    {
      slot: "reference-strip",
      note: "Root — empty-state panel, or the scrollable region (Carousel) once there's at least one item.",
    },
    {
      slot: "reference-strip-empty",
      note: "Whole-strip empty state: copy plus an Add CTA, not a bare string (F4).",
    },
    {
      slot: "reference-strip-item",
      note: "One slide wrapper; fixed width so slots don't reflow as the strip scrolls.",
    },
    {
      slot: "reference-strip-slot",
      note: "The per-item content: a preview-tile (A8) plus the role label / reorder row.",
    },
    ...
    {
      slot: "reference-strip-previous",
      note: 'Visible "scroll left" affordance; also keeps the strip keyboard-reachable.',
    },
