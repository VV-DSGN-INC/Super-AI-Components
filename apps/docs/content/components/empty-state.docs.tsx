...
export const EmptyStateDocs: ComponentDocs = {
  ...
  evidence: ["NotebookLM"],
  anatomy: [
    { slot: "empty-state", note: "Root. Carries data-size (page | panel | in-grid) and the frame metrics for that size." },
    { slot: "empty-state-header", note: "Groups the mark, title and description; left-aligned at in-grid size." },
    { slot: "empty-state-media", note: "The decorative mark. Always aria-hidden, so it can never add to an accessible name." },
    ...
    { slot: "empty-state-example-pair", note: "Before to after. A content mode, available at any of the three sizes." },
    { slot: "empty-state-example", note: "One half of the pair — a figure whose caption is also its accessible name." },
    { slot: "empty-state-example-label", note: "The visible caption. Required, so the direction survives without the arrow." },
