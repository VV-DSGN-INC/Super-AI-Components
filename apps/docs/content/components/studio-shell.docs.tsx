...
export const StudioShellDocs: ComponentDocs = {
  ...
  pitfalls: [
    ...
    "H5 composes the vendored carousel, whose previous and next buttons sit at `-left-12` and `-right-12` — outside the strip's own box. The page-strip region reserves gutters for them; remove that padding and the shell's `overflow-hidden` clips the strip's only keyboard-reachable scroll control.",
