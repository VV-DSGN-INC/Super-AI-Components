...
export const RateLimitBannerDocs: ComponentDocs = {
  ...
  anatomy: [
    {
      slot: "rate-limit-banner",
      note: "The inline frame. A note, not an alert — it persists, so it must not interrupt.",
    },
    ...
    {
      slot: "rate-limit-banner-countdown",
      note: "The live clock, and the reached-zero message that replaces it.",
    },
    {
      slot: "rate-limit-banner-no-eta",
      note: "Shown instead when no estimate exists. Never 'try again later'.",
    },
    {
      slot: "rate-limit-banner-notify",
      note: "The opt-in toggle. Label is stable; aria-pressed carries state.",
    },
    { slot: "rate-limit-banner-notify-status", note: "Visible confirmation once the opt-in is taken." },
    {
      slot: "rate-limit-banner-action",
      note: "An escape hatch that isn't waiting: upgrade, switch model, queue it.",
    },
    {
      slot: "rate-limit-banner-status",
      note: "Sr-only polite live region, deliberately coarse — see pitfalls.",
    },
  ],
  usage:
