...
export const PreviewTileDocs: ComponentDocs = {
  ...
  pitfalls: [
    ...
    "`failed` and `locked` inherit the surrounding text colour rather than painting their own. Colour the failure on an icon if you want one — `text-destructive` as body text on this frame's muted fill measures 4.34:1, under the 4.5:1 minimum, which is the contrast pairing this system keeps re-introducing.",
  ],
};
