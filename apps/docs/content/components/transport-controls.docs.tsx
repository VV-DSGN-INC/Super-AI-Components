...
export const TransportControlsDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "transport-controls-skip-forward",
      note: "Jump forward by `skipBy` seconds. Shared by both variants.",
    },
    {
    ...
    {
      slot: "transport-controls-duration",
      note: "Total length, beside elapsed inside the same joined field.",
    },
    {
      slot: "transport-controls-speed",
      note: "Playback-rate select, named so it is reachable without a tooltip.",
    },
    {
      slot: "transport-controls-range",
      note: "In/out points as text, so the marked range is never colour-only.",
    },
