...
export const TemplateDetailDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "template-detail-strip",
      note: "Carousel of thumbnails. Renders only when there is more than one preview.",
    },
    {
      slot: "template-detail-thumb",
      note: "One thumbnail. The current one carries aria-current, not just a ring.",
    },
    ...
    {
      slot: "field-row",
      note: "One labelled option row (its own slot, not renamed) — rendered through A6 field-row, addressed by data-option-id.",
    },
    { slot: "template-detail-related", note: "The 'more like this' section." },
    {
      slot: "template-detail-related-item",
      note: "One related tile — an inert A8 preview-tile inside a single button.",
    },
    {
      slot: "template-detail-use",
      note: "The commit. Emits the template id together with the configured options.",
    },
