...
export const ChatShellDocs: ComponentDocs = {
  ...
  accessibility: {
    ...
    focus: [
      ...
      "`sidebarPromo` and `sidebarFooter` are clipped out of view in an embedded shell (see the pitfalls), and clipped is not hidden: anything focusable you put in them stays in the tab order while being invisible.",
    ],
  },
  pitfalls: [
