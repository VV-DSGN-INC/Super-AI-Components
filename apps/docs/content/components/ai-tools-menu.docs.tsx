...
export const AiToolsMenuDocs: ComponentDocs = {
  ...
  accessibility: {
    ...
    screenReader: [
      ...
      "In inline mode every actionable row is a plain `<button>`. A9 `entity-row` stamps `aria-pressed` only when the caller passes `selected`, and this component does not, so Remove background announces as a one-shot action rather than as an unpressed toggle.",
