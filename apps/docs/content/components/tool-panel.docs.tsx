...
export const ToolPanelDocs: ComponentDocs = {
  ...
  anatomy: [
    ...
    {
      slot: "tool-panel-search",
      note: "Wrapper around the search field. The field itself is a standard input, found by role.",
    },
    { slot: "tool-panel-tabs", note: "Category switch. Only the active tab's sections are mounted." },
    {
      slot: "tool-panel-sections",
      note: "The scrolling body. Focusable in its own right so keyboard users can scroll it.",
    },
    ...
    {
      slot: "section-header",
      note: "A12, unchanged — title, count, 'View all' action and the collapse trigger.",
    },
    {
      slot: "tool-panel-section-content",
      note: "Rendered only while the section is visible. This is the lazy boundary.",
    },
    {
      slot: "tool-panel-grid",
      note: "The tile grid a section's `items` produce. Column count is a panel-level prop.",
    },
    {
      slot: "tool-panel-item",
      note: "One cell: a single button (or an inert div) wrapping one A8 preview-tile.",
    },
    {
      slot: "preview-tile",
      note: "A8, unchanged — aspect, thumbnail, overlay label, badge and selection ring.",
    },
    {
      slot: "tool-panel-empty",
      note: "Stands in for the sections when the caller has filtered them all away.",
    },
    {
      slot: "tool-panel-prompt",
      note: "The docked prompt. A sibling of the scrolling body, so it never scrolls away.",
    },
  ],
  usage:
