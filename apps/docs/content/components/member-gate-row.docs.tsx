...
export const MemberGateRowDocs: ComponentDocs = {
  ...
  anatomy: [
    {
      slot: "member-gate-row",
      note: "Root wrapper. Carries data-state for locked/unlocked/trial-available/inline-upsell.",
    },
    {
      slot: "member-gate-row-trailing",
      note: "Groups the tier or trial badge with the switch so they move as one unit.",
    },
    {
      slot: "member-gate-row-tier-badge",
      note: 'Shown whenever the row is gated (locked or its inline-upsell) — e.g. "Pro".',
    },
    { slot: "member-gate-row-trial-badge", note: 'Shown only in trial-available — e.g. "Free trial ×1".' },
    {
      slot: "member-gate-row-upsell",
      note: "The inline panel revealed under a locked row — never a dialog.",
    },
