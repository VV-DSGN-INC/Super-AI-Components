...
export const LibraryShellDocs: ComponentDocs = {
  ...
  accessibility: {
    ...
    screenReader: [
      ...
      "A tile's button reports `aria-pressed` only in select mode, because A8 stamps it only when a caller passes `selected`. In browse mode a tile announces as the open action it is.",
