...
export const ThreadListDocs: ComponentDocs = {
  ...
  pitfalls: [
    ...
    'Every row\'s actions button is named "Thread actions" and nothing else. In a sidebar of ten threads a screen-reader user hears ten identical buttons, with only reading order tying one to its thread — which is the real reason the row title above is worth keeping short and distinct.',
