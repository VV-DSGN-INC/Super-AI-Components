...
/** Subscribes to the embla api's scroll-state events and derives the current
    canScrollPrev/canScrollNext snapshot at render time, instead of calling
    setState synchronously inside an effect (react-hooks/set-state-in-effect). */
function useCarouselCanScroll(api: CarouselApi, direction: "prev" | "next") {
