...
/**
 * Shown inside a CostProvider on purpose: the shortfall line under the price
 * is derived from the balance held here, never handed to the card as a prop.
 */
export default function PaywallMessageDemo() {
  return (
    <CostProvider balance={120} onTopUp={() => {}}>
      <div className="flex w-full max-w-md flex-col gap-8">
        <PaywallMessage
          ...
          preview="8 seconds, 1080p — handheld drift past a ramen counter, sign flicker on the wet asphalt."
          before="I have the shot ready to go, but Veo 3.1 is not on your current plan, so I stopped before spending anything."
          after="Your prompt and model are held here — upgrading picks this back up exactly where it stopped. In the meantime I can storyboard it as stills."
          onUpgrade={() => {}}
        />
        ...
        <PaywallMessage
          ...
          before="Voice cloning is a Studio feature, so I stopped at the script rather than generating something you cannot use."
