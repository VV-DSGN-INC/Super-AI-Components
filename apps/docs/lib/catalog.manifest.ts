...
export const MANIFEST: ManifestItem[] = [
  ...
  },
  {
    ...
    title: "Node Palette",
    description:
      "Add-node catalog: grouped, searchable, as a popover or a docked rail, reading the modality registry.",
    family: "G",
    layer: "component",
    status: "planned",
    wave: 7,
  ...
  },
  {
    ...
    title: "Flow Shell",
    description:
      "The node builder screen: flow-canvas, node-palette, property-inspector and canvas-toolbar composed.",
    family: "O",
    layer: "block",
    status: "planned",
    wave: 7,
