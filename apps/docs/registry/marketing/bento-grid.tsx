...
function BentoCard({
  ...
  return (
    ...
    >
      ...
      <div className="z-10 flex flex-col gap-1 p-5 transition-transform duration-300 group-hover:-translate-y-8 group-focus-within:-translate-y-8">
        {icon && (
      ...
      <div
        ...
        className="absolute bottom-0 z-10 flex w-full translate-y-2 items-center p-5 opacity-0 transition-[opacity,transform] duration-300 group-hover:translate-y-0 group-hover:opacity-100 group-focus-within:translate-y-0 group-focus-within:opacity-100"
      >
